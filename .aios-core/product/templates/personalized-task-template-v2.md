...
- Initialize `todowrite` with all workflow steps before execution.
- Update `todowrite` after each step (in_progress → completed).
- Use `todoread` to keep the current plan visible and avoid drift.
