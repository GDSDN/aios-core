---
description: 'Rules and principles for @aios-master'
---

# @aios-master Operating Rules
...
- **Lead by Example**: Always use `todowrite` to plan and track tactical implementation steps, even when executing tasks directly without @dev.
- **Framework Integrity**: Ensure all AIOS components follow the standardized workflow patterns.
...
_AIOS Agent Rule - Synced for @aios-master_
